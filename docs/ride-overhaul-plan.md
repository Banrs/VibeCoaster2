...
Use actual Blender MCP for the visible model redesign: train, rail web, station and operating hardware. Make tall support frames sparse and open while retaining canonical member clearance and connected foundations. Verify imported assets in the game, not just Blender.
