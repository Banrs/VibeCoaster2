...
> **Rejected and rolled back on 25 September 2026.** The user reported unnecessary constant roll and late LSM placement in section 1 and an incorrect clifftop, then requested default.3. Source and both Play shortcuts now use default.3. The measurements below document rejected default.4 history, not user acceptance. Its local packages, profiles and outputs were moved to D:/Coding/Codex/vibecoasterlegacy/rejected-default4-20260925; see that folder’s archive-manifest.json and [HANDOFF.md](../../HANDOFF.md).

At the time of the rejected default.4 delivery, candidate11 replaced the previously criticized parts with connected force-authored sources. Native acceptance, exact-save reload, final-package front/rear traversal, agent visual review and playable activation were completed. Both Play shortcuts then loaded the candidate11 save in UserData-Riftwake-V4; they now load default.3. Work on that delivery continued solo after every subagent reached its stopping point.
...
Root inspected all ten final-package third-person images at larger size, all 64 rear POV images in timestamped contact sheets, and earlier front POV frames from the identical saved geometry. The [outward-bank view](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/30-review-cliff-outward-bank.png) shows the sustained 50-degree outward bank over the exposed bay; the [whole shelf](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/31-review-cliff-winding.png) shows opposing and nested shallow turns. The [actual low pullout](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/40-review-boost-pullout.png) has a measured 2.262 m rail gap. The first uphill camera is shadowed but shows its rail and terrain bed; the other boost views are visible. Dedicated [Wave](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/45-review-wave-turnaround.png), [inversion](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/51-review-loop-immel-spacing.png), [closure](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/60-review-post-inversion-closure.png) and [final return](../../../vibecoasterlegacy/rejected-default4-20260925/outputs/riftwake-default4-runtime-front-v2/70-review-final-return.png) views cover the remaining requested geometry. Continuous force, curvature and flatness conclusions also rely on native trace audits, not isolated screenshots.
...
At default.4 activation, dist/current.json, the repository Play shortcut and desktop VibeCoaster2 shortcut targeted its final standalone and UserData-Riftwake-V4, with -CoasterLoad. Both shortcut targets and arguments were read back, and the save matched candidate11’s SHA256. out/riftwake-default4-activation.json records those historical identities and the rollback paths. The current pointer and shortcuts target default.3.

At the historical default.4 activation, out/default4-activation-backup/ held the prior default.3 pointer, shortcuts and accepted save. Those backups and the default.4 profile are now in the adjacent rejected-default4 archive. UserData-Riftwake-V3 and the active default.3 package remain in this workspace. The old task left a game process running then; that is not a current process claim.
