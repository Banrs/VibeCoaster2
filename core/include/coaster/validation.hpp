...
namespace coaster {
// Fresh source/dynamics/terrain-and-track evidence. Supports and other scene
// objects have a separate clearance audit; this is not whole-standard approval.
struct RideValidation {
    ...
    std::array<double, 8> checkSeconds{};
    unsigned workers{};
};
