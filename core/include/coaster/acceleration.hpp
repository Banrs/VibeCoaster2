...
AccelerationAssessment assessAccelerationF2291_25(
    const AccelerationSeries& series,
...
AccelerationAssessment assessProcessedAccelerationF2291_25(
    const AccelerationSeries& processedSeries,
    const std::function<bool()>& cancel = {});
