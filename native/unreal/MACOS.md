...
The default ALL RECORDS mode must remain unavailable until an authentic eligible processed I305/Pantherian benchmark is supplied. Explicit PHYSICS-PROOF remains labeled as intensity untested. All selected geometry/dynamic targets and the mandatory 960/1920 Hz verification still apply. Run the portable C++ suites on the Mac as well; the six UE contracts do not establish numerical portability alone.
