...
int main(int argc,char** argv){try{
    if(argc<2){std::cerr<<"Usage: coaster_cli generate [--seed N --terrain flat|hills|canyon --preset all-records|physics-proof --candidates N --step SECONDS --json PATH --trace PATH --plan PATH --out PATH]\n       coaster_cli validate FILE [--json PATH]\n";return 1;}
