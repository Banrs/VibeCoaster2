...
output=EXPORT+"/train_car_runtime.glb"
...
manifest["exports"]["train_car_runtime.glb"]={"status":"written","path":output}
scene["VCTrain_manifest_json"]=json.dumps(manifest)
print("VC_TRAIN_STAGE_07_EXPORTED="+json.dumps(manifest))
