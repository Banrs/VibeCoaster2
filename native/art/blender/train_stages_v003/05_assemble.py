...
parts=[m for m in bpy.data.meshes if m.name.startswith(PREFIX+"V003Snapshot_")]
assert len(parts)==97, "Expected 57 car + 40 review bogie snapshots"
...
bogie=assemble(PREFIX+"SM_Bogie_REVIEW_ONLY",review)
car["clearance_status"]="Source above-rail bounds asserted; imported UE and POV review pending"
bogie["clearance_status"]="UNVALIDATED moving below-rail wheel hardware; not runtime"
manifest={"schema":"vibecoaster-train-art-1","build":"20260908-train-v003","blender":bpy.app.version_string,
 "source_blend":SOURCE+"/VibeCoaster_Train.blend","exports_directory":EXPORT,
 "runtime_parts":len(runtime),"review_bogie_parts":len(review),"runtime_bounds_m":car_bounds,
 "review_bounds_m":bounds(review),"runtime_vertices":len(car.data.vertices),
 ...
 "runtime_export":"train_car_runtime","review_only_export":"bogie_review_unvalidated","exports":{}}
